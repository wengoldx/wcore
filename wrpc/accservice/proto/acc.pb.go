...
var file_proto_acc_proto_rawDesc = []byte{
	...
	0x52, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x32, 0x9a, 0x09, 0x0a, 0x03, 0x41, 0x63, 0x63, 0x12, 0x27,
	...
	0x6c, 0x73, 0x12, 0x29, 0x0a, 0x0b, 0x41, 0x63, 0x63, 0x41, 0x63, 0x74, 0x69, 0x76, 0x61, 0x74,
...
var file_proto_acc_proto_depIdxs = []int32{
	...
	2,  // 12: proto.Acc.AccActivate:input_type -> proto.UUID
	2,  // 13: proto.Acc.GetProfile:input_type -> proto.UUID
	3,  // 14: proto.Acc.GetProfSumms:input_type -> proto.UIDS
	2,  // 15: proto.Acc.GetContact:input_type -> proto.UUID
	2,  // 16: proto.Acc.GetCreatetime:input_type -> proto.UUID
	4,  // 17: proto.Acc.StoreAddMach:input_type -> proto.Email
	23, // 18: proto.Acc.StoreAddComp:input_type -> proto.Composer
	24, // 19: proto.Acc.StoreUpComp:input_type -> proto.CompSimp
	17, // 20: proto.Acc.StoreBindWx:input_type -> proto.WxBind
	6,  // 21: proto.Acc.StoreUnbindWx:input_type -> proto.AccPwd
	2,  // 22: proto.Acc.StoreProfile:input_type -> proto.UUID
	3,  // 23: proto.Acc.StoreProfiles:input_type -> proto.UIDS
	15, // 24: proto.Acc.StoreRename:input_type -> proto.RnStore
	3,  // 25: proto.Acc.StoreAccDel:input_type -> proto.UIDS
	...
	0,  // 38: proto.Acc.AccActivate:output_type -> proto.AEmpty
	9,  // 39: proto.Acc.GetProfile:output_type -> proto.Profile
	11, // 40: proto.Acc.GetProfSumms:output_type -> proto.ProfSumms
	12, // 41: proto.Acc.GetContact:output_type -> proto.Contact
	5,  // 42: proto.Acc.GetCreatetime:output_type -> proto.CreateTime
	...
	0,  // 51: proto.Acc.StoreAccDel:output_type -> proto.AEmpty
