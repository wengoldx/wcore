...
var file_proto_acc_proto_rawDesc = []byte{
	...
	0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x04, 0x70, 0x61, 0x73, 0x73, 0x32, 0xfe, 0x05,
	...
	0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x27, 0x0a, 0x08, 0x56, 0x69, 0x61, 0x41, 0x64, 0x6d, 0x69,
	0x6e, 0x12, 0x0c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x1a,
	0x0d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x41, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x12, 0x27,
	...
	0x6f, 0x2e, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x29, 0x0a, 0x0a, 0x47, 0x65, 0x74, 0x50, 0x72,
	...
	0x0d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x41, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x42, 0x09,
...
var file_proto_acc_proto_depIdxs = []int32{
	...
	17, // 3: proto.Acc.ViaRole:input_type -> proto.Role
	...
	3,  // 7: proto.Acc.GetProfSumms:input_type -> proto.UIDS
	2,  // 8: proto.Acc.GetContact:input_type -> proto.UUID
	2,  // 9: proto.Acc.GetCreatetime:input_type -> proto.UUID
	10, // 10: proto.Acc.StoreRegister:input_type -> proto.RegStore
	2,  // 11: proto.Acc.StoreProfile:input_type -> proto.UUID
	3,  // 12: proto.Acc.StoreProfiles:input_type -> proto.UIDS
	13, // 13: proto.Acc.StoreRename:input_type -> proto.RnStore
	14, // 14: proto.Acc.StoreBindWx:input_type -> proto.WxBind
	9,  // 15: proto.Acc.SetContact:input_type -> proto.Contact
	15, // 16: proto.Acc.BindAccount:input_type -> proto.Secures
	5,  // 17: proto.Acc.UnbindUnionID:input_type -> proto.AccPwd
	2,  // 18: proto.Acc.UnbindUnionID2:input_type -> proto.UUID
	5,  // 19: proto.Acc.ViaToken:output_type -> proto.AccPwd
	18, // 20: proto.Acc.ViaRole:output_type -> proto.Result
	0,  // 21: proto.Acc.ViaAdmin:output_type -> proto.AEmpty
	1,  // 22: proto.Acc.AccLogin:output_type -> proto.Token
	6,  // 23: proto.Acc.GetProfile:output_type -> proto.Profile
	8,  // 24: proto.Acc.GetProfSumms:output_type -> proto.ProfSumms
	9,  // 25: proto.Acc.GetContact:output_type -> proto.Contact
	4,  // 26: proto.Acc.GetCreatetime:output_type -> proto.CreateTime
	2,  // 27: proto.Acc.StoreRegister:output_type -> proto.UUID
	11, // 28: proto.Acc.StoreProfile:output_type -> proto.ProfStore
	12, // 29: proto.Acc.StoreProfiles:output_type -> proto.ProfStores
	0,  // 30: proto.Acc.StoreRename:output_type -> proto.AEmpty
	0,  // 31: proto.Acc.StoreBindWx:output_type -> proto.AEmpty
	0,  // 32: proto.Acc.SetContact:output_type -> proto.AEmpty
	1,  // 33: proto.Acc.BindAccount:output_type -> proto.Token
	0,  // 34: proto.Acc.UnbindUnionID:output_type -> proto.AEmpty
	0,  // 35: proto.Acc.UnbindUnionID2:output_type -> proto.AEmpty
