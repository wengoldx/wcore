...
type WgpayClient interface {
	...
	// update amount
	ChangeTAmount(ctx context.Context, in *NoAment, opts ...grpc.CallOption) (*PayEmpty, error)
	ChangeRAmount(ctx context.Context, in *NoAment, opts ...grpc.CallOption) (*PayEmpty, error)
	// revoke transaction
	RevokeTrade(ctx context.Context, in *No, opts ...grpc.CallOption) (*PayEmpty, error)
	RevokeRefund(ctx context.Context, in *No, opts ...grpc.CallOption) (*PayEmpty, error)
	// update transaction
	UpdateTrade(ctx context.Context, in *UpTrade, opts ...grpc.CallOption) (*PayEmpty, error)
	UpdateRefund(ctx context.Context, in *UpRefund, opts ...grpc.CallOption) (*PayEmpty, error)
	// get trade ticket
...
func (c *wgpayClient) ChangeTAmount(ctx context.Context, in *NoAment, opts ...grpc.CallOption) (*PayEmpty, error) {
	out := new(PayEmpty)
...
func (c *wgpayClient) ChangeRAmount(ctx context.Context, in *NoAment, opts ...grpc.CallOption) (*PayEmpty, error) {
	out := new(PayEmpty)
...
func (c *wgpayClient) RevokeTrade(ctx context.Context, in *No, opts ...grpc.CallOption) (*PayEmpty, error) {
	out := new(PayEmpty)
...
func (c *wgpayClient) RevokeRefund(ctx context.Context, in *No, opts ...grpc.CallOption) (*PayEmpty, error) {
	out := new(PayEmpty)
...
func (c *wgpayClient) UpdateTrade(ctx context.Context, in *UpTrade, opts ...grpc.CallOption) (*PayEmpty, error) {
	out := new(PayEmpty)
...
func (c *wgpayClient) UpdateRefund(ctx context.Context, in *UpRefund, opts ...grpc.CallOption) (*PayEmpty, error) {
	out := new(PayEmpty)
...
type WgpayServer interface {
	...
	// update amount
	ChangeTAmount(context.Context, *NoAment) (*PayEmpty, error)
	ChangeRAmount(context.Context, *NoAment) (*PayEmpty, error)
	// revoke transaction
	RevokeTrade(context.Context, *No) (*PayEmpty, error)
	RevokeRefund(context.Context, *No) (*PayEmpty, error)
	// update transaction
	UpdateTrade(context.Context, *UpTrade) (*PayEmpty, error)
	UpdateRefund(context.Context, *UpRefund) (*PayEmpty, error)
	// get trade ticket
...
func (UnimplementedWgpayServer) ChangeTAmount(context.Context, *NoAment) (*PayEmpty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ChangeTAmount not implemented")
}
func (UnimplementedWgpayServer) ChangeRAmount(context.Context, *NoAment) (*PayEmpty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ChangeRAmount not implemented")
}
func (UnimplementedWgpayServer) RevokeTrade(context.Context, *No) (*PayEmpty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RevokeTrade not implemented")
}
func (UnimplementedWgpayServer) RevokeRefund(context.Context, *No) (*PayEmpty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RevokeRefund not implemented")
}
func (UnimplementedWgpayServer) UpdateTrade(context.Context, *UpTrade) (*PayEmpty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateTrade not implemented")
}
func (UnimplementedWgpayServer) UpdateRefund(context.Context, *UpRefund) (*PayEmpty, error) {
