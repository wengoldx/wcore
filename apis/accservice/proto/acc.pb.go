...
type UnionID struct {
	...
	Unionid string `protobuf:"bytes,1,opt,name=unionid,proto3" json:"unionid,omitempty"` // wechat unionid
}

func (x *UnionID) Reset() {
	*x = UnionID{}
	if protoimpl.UnsafeEnabled {
...
func (x *UnionID) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UnionID) ProtoMessage() {}

func (x *UnionID) ProtoReflect() protoreflect.Message {
	mi := &file_proto_acc_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UnionID.ProtoReflect.Descriptor instead.
func (*UnionID) Descriptor() ([]byte, []int) {
	return file_proto_acc_proto_rawDescGZIP(), []int{3}
}

func (x *UnionID) GetUnionid() string {
	if x != nil {
		return x.Unionid
	}
	return ""
...
type AuthModel struct {
	...
	Subject string `protobuf:"bytes,1,opt,name=subject,proto3" json:"subject,omitempty"` // verification request subject
	Object  string `protobuf:"bytes,2,opt,name=object,proto3" json:"object,omitempty"`   // verification request object
	Action  string `protobuf:"bytes,3,opt,name=action,proto3" json:"action,omitempty"`   // verification request action
}
...
func (x *AuthModel) GetSubject() string {
	if x != nil {
		return x.Subject
	}
	return ""
...
func (x *AuthModel) GetObject() string {
	if x != nil {
		return x.Object
	}
	return ""
...
func (x *AuthModel) GetAction() string {
	if x != nil {
		return x.Action
	}
	return ""
...
type AuthResp struct {
	...
	Isallow bool `protobuf:"varint,1,opt,name=isallow,proto3" json:"isallow,omitempty"` // is subject can use object, ture is allow, false is deny
}
...
func (x *AuthResp) GetIsallow() bool {
	if x != nil {
		return x.Isallow
	}
	return false
...
type WxUserInfo struct {
	...
	Openid     string   `protobuf:"bytes,1,opt,name=openid,proto3" json:"openid,omitempty"`         // wechat openid
	Nickname   string   `protobuf:"bytes,2,opt,name=nickname,proto3" json:"nickname,omitempty"`     // wechat user nickname
	Sex        int64    `protobuf:"varint,3,opt,name=sex,proto3" json:"sex,omitempty"`              // wechat user sex
	Province   string   `protobuf:"bytes,4,opt,name=province,proto3" json:"province,omitempty"`     // wechat user provice
	City       string   `protobuf:"bytes,5,opt,name=city,proto3" json:"city,omitempty"`             // wechat user city
	Country    string   `protobuf:"bytes,6,opt,name=country,proto3" json:"country,omitempty"`       // wechat user country
	Headimgurl string   `protobuf:"bytes,7,opt,name=headimgurl,proto3" json:"headimgurl,omitempty"` // wechat user header photo
	Privilege  []string `protobuf:"bytes,8,rep,name=privilege,proto3" json:"privilege,omitempty"`   // wechat user privileges
	UnionID    string   `protobuf:"bytes,9,opt,name=unionID,proto3" json:"unionID,omitempty"`       // wechat unionid
}
...
func (x *WxUserInfo) GetOpenid() string {
	if x != nil {
		return x.Openid
	}
	return ""
...
func (x *WxUserInfo) GetSex() int64 {
	if x != nil {
		return x.Sex
	}
	return 0
...
func (x *WxUserInfo) GetHeadimgurl() string {
	if x != nil {
		return x.Headimgurl
	}
	return ""
...
func (x *WxUserInfo) GetPrivilege() []string {
	if x != nil {
		return x.Privilege
	}
	return nil
...
func (x *WxUserInfo) GetUnionID() string {
	if x != nil {
		return x.UnionID
	}
	return ""
...
var file_proto_acc_proto_rawDesc = []byte{
	...
	,
	...
	0x72, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0

	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x6d, 0x64, 0x35, 0x70, 0x77, 0x64, 0x12, 0x18,
	0x0a, 0x07, 0x75, 0x6e, 0x69, 0x6f, 0x6e, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x07, 0x75, 0x6e, 0x69, 0x6f, 0x6e, 0x69, 0x64, 0x22, 0x55, 0x0a, 0x09, 0x41, 0x75, 0x74, 0x68,
	0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x12, 0x18, 0x0a, 0x07, 0x73, 0x75, 0x62, 0x6a, 0x65, 0x63, 0x74,
	...
	0x24, 0x0a, 0x08, 0x41, 0x75, 0x74, 0x68, 0x52, 0x65, 0x73, 0x70, 0x12, 0x18, 0x0a, 0x07, 0x69,
	0x73, 0x61, 0x6c, 0x6c, 0x6f, 0x77, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x69, 0x73,
	0x61, 0x6c, 0x6c, 0x6f, 0x77, 0x22, 0xf4, 0x01, 0x0a, 0x0a, 0x57, 0x78, 0x55, 0x73, 0x65, 0x72,
	...
	0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x03, 0x73, 0x65, 0x78, 0x12, 0x1a, 0x0a, 0x08, 0x70, 0x72,
	...
	,
	...
	0x63, 0x50, 0x77, 0x64, 0x12, 0x27, 0x0a, 0x08, 0x56, 0x69, 0x61, 0x41, 0x64, 0x6d, 0x69, 0x6e,
	0x12, 0x0c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x1a, 0x0d,
	...
	0x69, 0x6d, 0x65, 0x12, 0x2d, 0x0a, 0x0d, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x52, 0x65, 0x67, 0x69,
	0x73, 0x74, 0x65, 0x72, 0x12, 0x0f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x52, 0x65, 0x67,
	0x53, 0x74, 0x6f, 0x72, 0x65, 0x1a, 0x0b, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x55, 0x55,
	0x49, 0x44, 0x12, 0x2d, 0x0a, 0x0c, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x50, 0x72, 0x6f, 0x66, 0x69,
	...
	0x65, 0x73, 0x12, 0x2c, 0x0a, 0x0b, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x52, 0x65, 0x6e, 0x61, 0x6d,
	0x65, 0x12, 0x0e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x52, 0x6e, 0x53, 0x74, 0x6f, 0x72,
	0x65, 0x1a, 0x0d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x41, 0x45, 0x6d, 0x70, 0x74, 0x79,
	...
	0x6d, 0x70, 0x74, 0x79, 0x12, 0x2d, 0x0a, 0x08, 0x56, 0x69, 0x61, 0x41, 0x6c, 0x6c, 0x6f, 0x77,
	0x12, 0x10, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x41, 0x75, 0x74, 0x68, 0x4d, 0x6f, 0x64,
	0x65, 0x6c, 0x1a, 0x0f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x41, 0x75, 0x74, 0x68, 0x52,
...
var file_proto_acc_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
var file_proto_acc_proto_goTypes = []interface{}{
	(*AEmpty)(nil),     // 0: proto.AEmpty
	(*Token)(nil),      // 1: proto.Token
	(*UUID)(nil),       // 2: proto.UUID
	(*UnionID)(nil),    // 3: proto.UnionID
	(*UIDS)(nil),       // 4: proto.UIDS
	...
	(*RegStore)(nil),   // 11: proto.RegStore
	(*ProfStore)(nil),  // 12: proto.ProfStore
	(*ProfStores)(nil), // 13: proto.ProfStores
	(*RnStore)(nil),    // 14: proto.RnStore
	(*WxBind)(nil),     // 15: proto.WxBind
	(*Secures)(nil),    // 16: proto.Secures
	(*Admin)(nil),      // 17: proto.Admin
	(*AuthModel)(nil),  // 18: proto.AuthModel
	(*AuthResp)(nil),   // 19: proto.AuthResp
	(*WxUserInfo)(nil), // 20: proto.WxUserInfo
}
var file_proto_acc_proto_depIdxs = []int32{
	8,  // 0: proto.ProfSumms.summs:type_name -> proto.ProfSumm
	12, // 1: proto.ProfStores.profiles:type_name -> proto.ProfStore
	6,  // 2: proto.Acc.AccLogin:input_type -> proto.AccPwd
	20, // 3: proto.Acc.WxLogin:input_type -> proto.WxUserInfo
	1,  // 4: proto.Acc.ViaToken:input_type -> proto.Token
	17, // 5: proto.Acc.ViaAdmin:input_type -> proto.Admin
	2,  // 6: proto.Acc.GetProfile:input_type -> proto.UUID
	4,  // 7: proto.Acc.GetProfSumms:input_type -> proto.UIDS
	2,  // 8: proto.Acc.GetContact:input_type -> proto.UUID
	2,  // 9: proto.Acc.GetCreatetime:input_type -> proto.UUID
	11, // 10: proto.Acc.StoreRegister:input_type -> proto.RegStore
	2,  // 11: proto.Acc.StoreProfile:input_type -> proto.UUID
	4,  // 12: proto.Acc.StoreProfiles:input_type -> proto.UIDS
	14, // 13: proto.Acc.StoreRename:input_type -> proto.RnStore
	15, // 14: proto.Acc.StoreBindWx:input_type -> proto.WxBind
	10, // 15: proto.Acc.SetContact:input_type -> proto.Contact
	16, // 16: proto.Acc.BindAccount:input_type -> proto.Secures
	6,  // 17: proto.Acc.UnbindUnionID:input_type -> proto.AccPwd
	2,  // 18: proto.Acc.UnbindUnionID2:input_type -> proto.UUID
	18, // 19: proto.Acc.ViaAllow:input_type -> proto.AuthModel
	1,  // 20: proto.Acc.AccLogin:output_type -> proto.Token
	3,  // 21: proto.Acc.WxLogin:output_type -> proto.UnionID
	6,  // 22: proto.Acc.ViaToken:output_type -> proto.AccPwd
	0,  // 23: proto.Acc.ViaAdmin:output_type -> proto.AEmpty
	7,  // 24: proto.Acc.GetProfile:output_type -> proto.Profile
	9,  // 25: proto.Acc.GetProfSumms:output_type -> proto.ProfSumms
	10, // 26: proto.Acc.GetContact:output_type -> proto.Contact
	5,  // 27: proto.Acc.GetCreatetime:output_type -> proto.CreateTime
	2,  // 28: proto.Acc.StoreRegister:output_type -> proto.UUID
	12, // 29: proto.Acc.StoreProfile:output_type -> proto.ProfStore
	13, // 30: proto.Acc.StoreProfiles:output_type -> proto.ProfStores
	0,  // 31: proto.Acc.StoreRename:output_type -> proto.AEmpty
	0,  // 32: proto.Acc.StoreBindWx:output_type -> proto.AEmpty
	0,  // 33: proto.Acc.SetContact:output_type -> proto.AEmpty
	1,  // 34: proto.Acc.BindAccount:output_type -> proto.Token
	0,  // 35: proto.Acc.UnbindUnionID:output_type -> proto.AEmpty
	0,  // 36: proto.Acc.UnbindUnionID2:output_type -> proto.AEmpty
	19, // 37: proto.Acc.ViaAllow:output_type -> proto.AuthResp
